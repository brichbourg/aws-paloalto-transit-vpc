...
echo "Building transit-vpc-push-pan-config ZIP file"
...
echo "pip install $deployment_dir/../source/transit-vpc-push-pan-config/. --target=$deployment_dir/dist/env/lib/python2.7/site-packages/"
pip install $deployment_dir/../source/transit-vpc-push-pan-config/. --target=$deployment_dir/dist/env/lib/python2.7/site-packages/
cd $deployment_dir/dist/env/lib/python2.7/site-packages/
zip -r9 $deployment_dir/dist/transit-vpc-push-pan-config.zip .
cd $deployment_dir/dist
zip -q -d transit-vpc-push-pan-config.zip pip*
zip -q -d transit-vpc-push-pan-config.zip easy*
